...
/*function prefix_add_footer_styles() {
	...
	echo '<link rel=\'stylesheet\' id=\'reset-css\'  href=' . get_template_directory_uri() . '/css/reset.css\' type=\'text/css\' media=\'all\' />';
	echo '<link rel=\'stylesheet\' id=\'fonts-css\'  href=' . get_template_directory_uri() . '/css/fonts.css\' type=\'text/css\' media=\'all\' />';
	echo '<link rel=\'stylesheet\' id=\'styles-css\'  href=' . get_template_directory_uri() . '/css/styles.css\' type=\'text/css\' media=\'all\' />';
	echo '<link rel=\'stylesheet\' id=\'media-css\'  href=' . get_template_directory_uri() . '/css/media.css\' type=\'text/css\' media=\'all\' />';
	echo '<link rel=\'stylesheet\' id=\'awesome-css\'  href=\'https://maxcdn.bootstrapcdn.com/font-awesome/4.4.0/css/font-awesome.min.css\' type=\'text/css\' media=\'all\' />';
	echo '<link rel=\'stylesheet\' id=\'owl-css\'  href=' . get_template_directory_uri() . '/css/owl.carousel.min.css\' type=\'text/css\' media=\'all\' />';
	echo '<link rel=\'stylesheet\' id=\'sweetalert-css\'  href=' . get_template_directory_uri() . '/css/sweetalert.css\' type=\'text/css\' media=\'all\' />';
	echo '<link rel=\'stylesheet\' id=\'fancybox-css\'  href=\'https://cdnjs.cloudflare.com/ajax/libs/fancybox/3.1.20/jquery.fancybox.min.css\' type=\'text/css\' media=\'all\' />';
...
function hers_scripts(){
	...
	wp_register_style( 'demo-css', get_template_directory_uri() . '/css/demo.css',true,'1.1','all');
	wp_enqueue_style( 'demo-css' );
	
	wp_register_style( 'reset-css', get_template_directory_uri() . '/css/reset.css',true,'1.1','all');
	wp_enqueue_style( 'reset-css' );

	wp_register_style( 'fonts-css', get_template_directory_uri() . '/css/fonts.css',true,'1.1','all');
	wp_enqueue_style( 'fonts-css' );
	
	wp_register_style( 'styles-css', get_template_directory_uri() . '/css/styles.css',true,'1.1','all');
	wp_enqueue_style( 'styles-css' );
	
	wp_register_style( 'media-css', get_template_directory_uri() . '/css/media.css',true,'1.1','all');
	wp_enqueue_style( 'media-css' );
	
	wp_register_style( 'awesome-css', 'https://maxcdn.bootstrapcdn.com/font-awesome/4.4.0/css/font-awesome.min.css',true,'1.1','all');
	wp_enqueue_style( 'awesome-css' );
	
	wp_register_style( 'owl-css', get_template_directory_uri() . '/css/owl.carousel.min.css',true,'1.1','all');
	wp_enqueue_style( 'owl-css' );
 	
	wp_register_style( 'sweetalert-css', get_template_directory_uri() . '/css/sweetalert.css',true,'1.1','all');
	wp_enqueue_style( 'sweetalert-css' );
	
	wp_register_style( 'fancybox-css', 'https://cdnjs.cloudflare.com/ajax/libs/fancybox/3.1.20/jquery.fancybox.min.css',true,'1.1','all');
	wp_enqueue_style( 'fancybox-css' );
	
	wp_register_style( 'mmenu-css', get_template_directory_uri() . '/css/mmenu.css',true,'1.1','all');
