...
<body>
	...
	<div id="page">
		...
		<?php if($action_image){ ?>
			...
			<div class="wrap-sale-banner">

				<a href="<?php echo $link_action; ?>"><img class="sale-banner-main" src="<?php echo $action_image; ?>" alt=""></a>
					...
					<div class="col-md-12">
						...
						<div class="top-line">
							...
							<div class="left-block">
								...
								<div class="adress">
									<dl>
										<dd><address>УЛ. ДРЕВНЯЯ, 34<br>
											Г. СЕВАСТОПОЛЬ, АР КРЫМ</address></dd>
									</dl>
								</div>
...
<a alt="Онлайн продажи, управление отелем. Otelms.com" target="_blank" href="http://www.otelms.com" 
